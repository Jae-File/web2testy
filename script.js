...
let sentence='Last Sunday '+verb+ ' a '+ adj + ' ' + noun +'. On my way to the '+ noun + 'I '+verb +' a very ' + adj + noun + '. It '+verb+' so ' + adj + ' that I instantly '+ verb + ' over it. Later at night, my ' + noun + verb + ' to my '+ noun + ' and together we '+ verb + ' up, and ' + verb + ' some '+noun ;
